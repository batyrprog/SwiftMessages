...
class ViewController: UITableViewController {
    ...
    static func demoBasics() -> Void {
        ...
        let error = SwiftMessageView.viewFromNib(layout: .tabView)
        error.configureTheme(.error)
        error.configureContent(title: "Error", body: "Something is horribly wrong!")
        error.button?.setTitle("Stop", for: .normal)
        
        let warning = SwiftMessageView.viewFromNib(layout: .cardView)
        ...
        let success = SwiftMessageView.viewFromNib(layout: .cardView)
        ...
        let info = SwiftMessageView.viewFromNib(layout: .messageView)
        ...
        let status = SwiftMessageView.viewFromNib(layout: .statusLine)
        ...
        let status2 = SwiftMessageView.viewFromNib(layout: .statusLine)
    ...
    static func demoCentered() {
        let messageView: SwiftMessageView = SwiftMessageView.viewFromNib(layout: .centeredView)
